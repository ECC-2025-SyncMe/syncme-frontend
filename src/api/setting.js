...
export const getUserInfo = async () => axios.get('/users/me'); // 내 계정 정보 조회(이메일)

export const ChangeName = (data) => axios.patch('/users/me/nickname', data); // 프로필 편집(1)
...
export const DeleteUserInfo = async () => axios.delete('/users/me'); // 내 계정 정보 조회(5)
